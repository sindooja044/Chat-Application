...
const ChatBox = () => {
    ...
    const sendMessage = async () => {
        try {
            if (input && messagesId) {    //if inpput and messageId available
    ...
    const convertTimeStamp = (timestamp) => {   //AM PM logic
    ...
    useEffect(() => {
        ...
        if (messagesId) { //if messagesId available
    ...
    return chatUser ? (
        <div className={`chat-box ${chatVisible? "":"hidden"}`}>
            <div className="chat-user">
                <img src={chatUser.userData.avatar} alt="" />  {/* diplating perticular user puc and name */}
            ...
            <div className="chat-msg">
                {messages.map((msg, index) => (      //working on each msg
                    <div key={index} className={msg.sId === userData.id ? "s-msg" : "r-msg"}>
                        {msg["image"] ?               //msg visible logic
                            <img className="msg-img" src={msg.image} alt="" /> : <p className='msg'>{msg.text}</p>}
            ...
            <div className="chat-input">
                ...
                <input onChange={sendImage} type="file" id='image' accept='image/png,image/jpeg' hidden /> {/* file uploading image*/}
